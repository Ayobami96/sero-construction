            ...
            <div className='flex items-center md:gap-x-10 gap-y-6 md:flex-row flex-col justify-center'>
                ...
                <div className='basis-[28%] bg-ourMission bg-no-repeat bg-cover relative p-6 py-28'>
                    ...
                    <div className='relative z-1 space-y-3'>
                        ...
                        <div className='after:absolute w-10 h-[2px] bg-white'></div>
                        <p className='leading-relaxed font-normal text-base text-white'>To provide world class services in real estate,
                        constructions and consultancy; through productive scouting, innovative projects,
                        strategic partnership and exceptional customer friendly system.</p>
                    </div>
                </div>
            </div>
