        ...
        <div className='relative container sm:mx-auto lg:px-24 lg:py-24 py-12 px-4'>
            <div className='flex md:flex-row flex-col justify-center items-center gap-6'>
                ...
                <div className='basis-1/3 bg-seroBlue p-6 rounded-lg space-y-4 pb-16'>
                    ...
                    <p className='text-base font-normal leading-relaxed text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium vel mollitia inventore, molestiae quae ipsam a eos. Adipisci.</p>
                </div>
                <div className='basis-1/3 bg-seroBlue p-6 rounded-lg space-y-4 pb-16'>
